...
(function(exports, $, undefined) {
	...
	var Toast = function(opt) {
		...
		(typeof opt === 'string') && (opt = {text: opt});
		...
		var ele = '<div class="toast-box" style="max-width:'+options.width+'px;"><p>'+options.text+'</p></div>', $ele = $(ele);
		...
		if (options.autoPos) {
			...
			$ele.css({left: posLeft+'px', top: posTop+'px'});
		} else {
			$ele.css({left: options.x+'px', top: options.y+'px'});
		}
